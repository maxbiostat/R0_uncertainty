...
\newcommand{\speaker}[1]{\author[1,2]{\underline{#1}}}
...
\affil[2]{Institute of Evolutionary Biology, University of Edinburgh, United Kingdom} % Write affiliation/s of the first co-author here, if there is any. If not, remove the line.
\affil[3]{School of Applied Mathematics, Getulio Vargas Foundation (FGV), Brazil,\,\emailaddress{fccoelho@fgv.br}} % Write affiliation/s of the first co-author here, if there is any. If not, remove the line.
...
Thus, the distributions on ${\cal R}_0$ obtained using procedures (a) and (b) need not coincide. % LM: Clearly, (a) and (b) only lead to the same distribution in the trivial case $\alpha_j = 1$, which is a danger for the KL approach.
