...
One might argue that procedure (b) makes little sense, given that the set of opinions $\mathbf{F}(\theta)$ concerns only $\theta$, i.e, it was not necessarily constructed taking the transformation $M(\cdot)$ into account.
